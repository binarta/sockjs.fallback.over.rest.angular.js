# sockjs.fallback.over.rest.angular.js

[AngularJS](http://angularjs.org/) module providing a fallback mechanism using REST for sockjs based on the [Binarta](http://binarta.com/) platform.
